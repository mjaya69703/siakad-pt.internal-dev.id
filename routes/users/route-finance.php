...
Route::group(['prefix' => 'finance', 'middleware' => ['user-access:Departement Finance'], 'as' => 'finance.'],function(){
    ...
    Route::middleware(['is-active:1'])->group(function () {
        ...
        // MENU KHUSUS FINANCE DEPARTEMENT => DATA TAGIHAN (TEMPORARILY DISABLED)
        ...
        // MENU KHUSUS FINANCE DEPARTEMENT => DATA PEMBAYARAN (TEMPORARILY DISABLED)
        ...
        // MENU KHUSUS FINANCE DEPARTEMENT => DATA KEUANGAN (TEMPORARILY DISABLED)
        ...
        // MENU KHUSUS FINANCE DEPARTEMENT => DATA APPROVAL ABSENSI KARYAWAN (TEMPORARILY DISABLED)
