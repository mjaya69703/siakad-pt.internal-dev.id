                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                        <div class="card card-plain">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('mahasiswa.auth-signin-post')); ?>" method="POST" role="form">
                                    <?php echo csrf_field(); ?>
                            ...
                            <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                <p class="mb-0 text-sm mx-auto">
                                    Lost an password?
                                    <a href="<?php echo e(route('mahasiswa.auth-forgot-page')); ?>" class="text-primary text-gradient font-weight-bold">Come Here</a>
                                </p>
                                <p class="mb-0 text-sm mx-auto">
                                    Back to home?
...
<?php echo $__env->make('base.base-auth-index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/siakadpt/htdocs/siakad-pt.internal-dev.id/resources/views/base/auth/auth-mhs-signin.blade.php ENDPATH**/ ?>