                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Absen Hadir</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Absen Sakit</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="contact-tab" data-bs-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Izin / Cuti</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <form action="{{ route($prefix . 'home-presensi-update-absen') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-12 col-lg-12 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('storage/images/' . $absen->absen_proof) }}" class="card-img-top" loading="lazy" alt="">
                                        </div>
                                        ...
                                        <div class="form-group col-12 col-lg-6">
                                            ...
                                            <select name="absen_type" id="absen_type" class="form-control">
                                                ...
                                                <option value="0" {{ $absen->raw_absen_type === 0 ? 'selected' : '' }}>Absen Regular ( 08.00 - 16.00 )</option>
                                                <option value="1" {{ $absen->raw_absen_type === 1 ? 'selected' : '' }}>Absen Lembur ( 16.00 - 21.00 )</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-12 col-lg-6">
                                            <label for="absen_date">Pilih Tanggal</label>
                                            <input type="date" class="form-control" name="absen_date" id="absen_date" readonly value="{{ $absen->absen_date }}" placeholder="Pilih Tanggal...">
                                        ...
                                        <div class="form-group col-12 col-lg-6">
                                            ...
                                            <input type="time" class="form-control" name="absen_time_in" id="absen_time_in" {{ $absen->absen_time_in !== null ? 'readonly' : '' }} value="{{ $absen->absen_time_in }}" placeholder="Jam Masuk">
                                            @error('absen_time_in')
                                                <span class="text-danger" style="font-size: 10px">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="form-group col-12 col-lg-6">
                                            ...
                                            <input type="time" class="form-control" name="absen_time_out" id="absen_time_out" value="{{ $absen->absen_time_out }}" placeholder="Jam Masuk">
                                            @error('absen_time_out')
                                                <span class="text-danger" style="font-size: 10px">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="form-group col-12 col-lg-12">
                                            <label for="absen_desc">Apa saja yang dikerjakan hari ini?</label>
                                        ...
                                        <div class="d-flex justify-content-end align-items-center">
                                            @if (Route::is([$prefix . 'home-presensi-update'], [$prefix . 'home-presensi']))
                            ...
                            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                ...
                                <form action="{{ route($prefix . 'home-presensi-input-izin') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="d-flex justify-content-end align-items-center">
                                            @if (Route::is($prefix . 'home-presensi'))
                                                <button type="submit" class="btn btn-outline-primary"><i style="margin-right: 5px" class="fa-solid fa-paper-plane"></i> Save</button>
                                            @endif
                                        </div>
                                    </div>
