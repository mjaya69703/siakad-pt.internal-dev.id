...
@endphp
@if(Route::is('web-admin.staffmanager-create-admin', request()->path()))

{{ route('web-admin.staffmanager-admin-index') }}
@elseif(Route::is('web-admin.staffmanager-create-staff', request()->path()))
{{ route('web-admin.staffmanager-staff-index') }}
@endif
@endsection
@section('subdesc')
    Halaman untuk menambah staff
@endsection
@section('content')

<form action="{{ route('web-admin.staffmanager-create-save') }}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-lg-4 col-12">
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h4 class="card-title">Tambah Foto Profile</h4>
                    <div class="">
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6 col-12">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <input type="password" class="form-control" name="code" id="SecurityKey" placeholder="Di Generate Otomatis" disabled>
