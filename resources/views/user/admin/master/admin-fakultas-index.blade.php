...
<section class="section row">
    ...
    <div class="col-lg-4 col-12">
        <form action="{{ route('web-admin.master.fakultas-store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card">
...
<div class="me-1 mb-1 d-inline-block">
    ...
    <form action="{{ route('web-admin.master.fakultas-update', $item->code) }}" method="POST" enctype="multipart/form-data">
        @method('patch')
        @csrf
