                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="hadir-tab" data-bs-toggle="tab" href="#hadir" role="tab" aria-controls="hadir" aria-selected="true">Absen Hadir</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="izin-tab" data-bs-toggle="tab" href="#izin" role="tab" aria-controls="izin" aria-selected="false">Izin / Cuti</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="terlambat-tab" data-bs-toggle="tab" href="#terlambat" role="tab" aria-controls="terlambat" aria-selected="false">Terlambat</a>
                            </li>
                        </ul>
                                            ...
                                            <tr>
                                                ...
                                                @if (Route::is('web-admin.staffmanager-admin-index', request()->path()))
                                                    <td class="d-flex justify-content-center align-items-center">
                                                        ...
                                                        <form id="delete-form-{{ $item->code }}" action="{{ route('web-admin.staffmanager-admin-destroy', $item->code) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a type="button" class="bs-tooltip btn btn-rounded btn-outline-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" data-original-title="Delete" data-url="{{ route('web-admin.staffmanager-admin-destroy', $item->code) }}" data-name="{{ $item->name }}" onclick="deleteData('{{ $item->code }}')">
                                                ...
                                                @elseif(Route::is('web-admin.staffmanager-staff-index', request()->path()))
                                                    <td class="d-flex justify-content-center align-items-center">
                                                        ...
                                                        <form id="delete-form-{{ $item->code }}" action="{{ route('web-admin.staffmanager-staff-destroy', $item->code) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a type="button" class="bs-tooltip btn btn-rounded btn-outline-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" data-original-title="Delete" data-url="{{ route('web-admin.staffmanager-staff-destroy', $item->code) }}" data-name="{{ $item->name }}" onclick="deleteData('{{ $item->code }}')">
                                                                <i class="fas fa-trash"></i>
                                                            </a>
                                                        </form>
                                                    </td>
